...
namespace XamarinMobile.Clients.Services.Request
{
    public class RequestService : IRequestService
    {
        ...
        public async Task<TResult> PutAsync<TResult, TRequest>(string uri, TRequest data, string token = "")
        {
            HttpClient httpClient = CreateHttpClient(token);
            string serialized = await Task.Run(() => JsonConvert.SerializeObject(data, _serializerSettings));
        ...
        /// <summary>
        /// Realiza la creación de una instancia HttpClient a la cual agrega una cabecera Authorization
        /// </summary>
        ...
        /// <summary>
        /// Evalua la respuesta generada por el servicio
        /// </summary>
